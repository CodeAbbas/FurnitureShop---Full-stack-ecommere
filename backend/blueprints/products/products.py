...
# Access the products collection from globals
...
def get_all_products():
    ...
    try:
        products_cursor = products_collection.find().skip(page_start).limit(page_size)
...
def edit_product(p_id):
    ...
    # Map form data to update fields if they exist in the request
